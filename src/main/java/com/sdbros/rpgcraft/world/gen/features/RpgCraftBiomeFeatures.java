...
public class RpgCraftBiomeFeatures {
    ...
    public static void addOreGeneration() {
        for (Biome biome : ForgeRegistries.BIOMES) {
            ...
            biome.addFeature(GenerationStage.Decoration.SURFACE_STRUCTURES, Biome.createDecoratedFeature(ModFeatures.BROKEN_TOWER, IFeatureConfig.NO_FEATURE_CONFIG,  Placement.CHANCE_HEIGHTMAP, new ChanceConfig(1)));
