...
public class UnstableChunkGenerator extends ChunkGenerator<GenerationSettings> {
    ...
    public void generateSurface(IChunk chunk) {
        ...
        int x1, y1, z1;
        int worldHeight = RpgCraftConfig.CONFIG.world_height.get();
        ...
        if (RpgCraftConfig.CONFIG.grass_enable.get()) {
            for (x1 = 0; x1 < 16; x1++) {
