...
public class RCOreFeature extends Feature<RCOreFeatureConfig> {
    public static final RCOreFeature INSTANCE = new RCOreFeature(RCOreFeatureConfig::deserialize);

    public RCOreFeature(Function<Dynamic<?>, ? extends RCOreFeatureConfig> configFactoryIn) {
        super(configFactoryIn);
    }

    @Override
    public boolean place(IWorld worldIn, ChunkGenerator<? extends GenerationSettings> generator, Random rand, BlockPos pos, RCOreFeatureConfig config) {
