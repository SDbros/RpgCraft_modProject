...
public class NeatBarConfig {
    ...
    private static ConfigValue<Boolean> v_showLevel;
    ...
    public static boolean showCurrentHP = false;
    ...
    static class Loader {
        ...
        public Loader(ForgeConfigSpec.Builder builder) {
            ...
            v_showLevel = builder.define("Show Max Level", showLevel);
